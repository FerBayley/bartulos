...
$tabla_ado = "bar_materiales"; 
$tabla = "bar_materiales"; 
$ordenar_ado = "nombre ASC"; 
$url_form = "materiales-frm.php"; 
$url_list = "materiales.php";
$campos_select = " * "; 
              ...
              <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-lista">
				...
				?>
                  <tr class="odd gradeX">
                    ...
                    <td>(<?php echo contar_registros("bar_productos", $con, $rs_lista->fields['id'], "id_material")?>)</td>
