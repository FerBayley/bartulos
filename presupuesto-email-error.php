	...
	<section class="Container">
		...
		<section class="Gracias">
			<section class="Caution">
				<img src="assets/images/caution.png" height="70" width="70" alt="No se envio correctamente">
			</section> <!-- / Caution -->
			<p>El envio no se realizo, por favor intentalo nuevamente.</p>
			<h6>Por dudas o consultas escribinos a: <a href="mailto:contaco@bartulosbazar.com">contaco@bartulosbazar.com</a></h6>
